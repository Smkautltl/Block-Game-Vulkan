...
public:
    ...
    DescriptorWriter& writeImages(uint32_t binding, VkDescriptorImageInfo(imageInfo)[MAX_TEXTURES]);
    DescriptorWriter& writeSampler(uint32_t binding, VkDescriptorImageInfo* samplerInfo);
